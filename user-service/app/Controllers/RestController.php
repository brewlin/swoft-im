 ...
 * RESTful和参数验证测试demo
 *
 * @Controller(prefix="/user-service")
 */
class RestController
{
     ...
     * 地址:/user-service/
     *
     * @RequestMapping(route="/user-service", method={RequestMethod::GET})
     */
     ...
     * 地址:/user-service
     *
     * @RequestMapping(route="/user-service", method={RequestMethod::POST,RequestMethod::PUT})
     *
