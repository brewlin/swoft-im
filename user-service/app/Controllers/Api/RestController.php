 ...
 * RESTful和参数验证测试demo.
 *
 * @Controller(prefix="/api/user-service")
 */
class RestController
{
     ...
     * 地址:/api/user-service/.
     *
     * @RequestMapping(route="/api/user-service", method={RequestMethod::GET})
     */
     ...
     * 地址:/api/user-service.
     *
     * @RequestMapping(route="/api/user-service", method={RequestMethod::POST,RequestMethod::PUT})
     *
