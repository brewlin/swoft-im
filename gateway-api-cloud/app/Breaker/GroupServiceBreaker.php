 ...
 *
 * @Breaker("groupService")
 */
class GroupServiceBreaker extends CircuitBreaker
{
    /**
     * The number of successive failures
     * If the arrival, the state switch to open
     *
     * @Value(name="${config.breaker.group_service.failCount}")
     * @var int
     */
     ...
     *
     * @Value(name="${config.breaker.group_service.successCount}")
     * @var int
     */
     ...
     *
     * @Value(name="${config.breaker.group_service.delayTime}")
     * @var int
     */
